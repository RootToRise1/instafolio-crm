...
function check_missing_language_strings($language)
{
    ...
    if (isset($keys_missing)) {
        echo '<br />--<br />Language keys missing please create <a href="https://help.instafolio.com/overwrite-translation-text/" target="_blank">custom_lang.php</a> and add the keys listed above.';
...
function _check_deprecated_calendar_view_name_option($value, $name)
{
    if ($name === 'default_view_calendar' &&
            is_client_logged_in() &&
            get_option('_v283_update_clients_theme') !== 'instafolio' &&
            active_clients_theme() !== 'instafolio' &&
