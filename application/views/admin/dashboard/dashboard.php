...
<div id="wrapper">
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-12 hr-widgets-row">
                <div class="row hr-widgets-inner hr-widgets-equal">
                    <div class="col-sm-6" data-container="hr-top-left">
                        <?php render_dashboard_widgets('hr-top-left'); ?>
                    </div>
                    <div class="col-sm-6" data-container="hr-top-right">
                        <?php render_dashboard_widgets('hr-top-right'); ?>
                    </div>
                </div>
            </div>
...
.hr-widgets-inner.hr-widgets-equal {
    align-items: stretch;
}
.hr-widgets-row .col-sm-6 {
    padding-left: 10px;
    padding-right: 10px;
    display: flex;
    flex-direction: column;
}
.hr-widgets-row .col-sm-6 > .widget {
    flex: 1;
    display: flex;
    flex-direction: column;
}
.hr-widgets-row .col-sm-6 > .widget .panel_s {
    flex: 1;
}
.hr-widgets-row .panel_s {
