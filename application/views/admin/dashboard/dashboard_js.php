...
// HR Attendance Clock - Realtime update
function updateHRAttendanceClock() {
    ...
    var workedEl = document.getElementById('worked-hours');
    if (workedEl) {
        var checkin = workedEl.getAttribute('data-checkin');
        if (checkin) {
            var now = new Date();
            ...
            workedEl.textContent = h + 'h ' + m + 'm';
        }
    }
}
updateHRAttendanceClock();
setInterval(updateHRAttendanceClock, 1000);
</script>
