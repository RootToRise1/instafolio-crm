 ...
 */
define('UPDATE_URL', 'https://www.instafolio.com/instafolio_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://www.instafolio.com/instafolio_updates/update_info.php');
