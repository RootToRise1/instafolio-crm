...
(function ($) {
  var FormBuilder = function FormBuilder(options, element) {
    ...
    var prepFieldVars = function prepFieldVars($field) {
      ...
      field.name = isNew ? field.name || nameAttr(field) : field.name || nameAttr(field);
    ...
    var textAttribute = function textAttribute(attribute, values) {
      ...
      var placeholderFields = ['text', 'textarea', 'email', 'date', 'datetime', 'select', 'color'];
    ...
    $sortableFields.on('input.error', 'keyup', function () {
